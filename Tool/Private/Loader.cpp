...
HRESULT CLoader::Loading_ForPokemonStateLevel()
{
	...
	//{
		if (FAILED(pGameInstance->Add_Prototype(LEVEL_POKEMONSTATE, TEXT("Prototype_Component_Texture_window_ATK_icon"),
			CTexture::Create(m_pDevice, m_pContext, TEXT("../../Reference/Resources/Texture/Window/window_ATK_icon.dds")))))
			return E_FAIL;

		if (FAILED(pGameInstance->Add_Prototype(LEVEL_POKEMONSTATE, TEXT("Prototype_Component_Texture_window_HP_icon"),
