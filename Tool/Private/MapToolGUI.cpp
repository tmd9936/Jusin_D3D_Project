...
void CMapToolGUI::TerrainMenu()
{
	...
	if (ImGui::Button("Change Size"))
	{
		...
		const _uint iLevelindex = CDataToolGUI::GetInstance()->Get_Current_Levelindex();
		CComponent* pTerrain_VIbuffer = CGameInstance::GetInstance()->Get_Component(CVIBuffer_FlatTerrain::familyId, iLevelindex, L"Layer_Terrain", L"Terrain");
	...
	{
		const _uint iLevelindex = CDataToolGUI::GetInstance()->Get_Current_Levelindex();
		CTexture* pMaskTexture = dynamic_cast<CTexture*>(CGameInstance::GetInstance()->Get_Component(FAMILY_ID_TEXTURE_MASK, iLevelindex, L"Layer_Terrain", L"Terrain"));
...
HRESULT CMapToolGUI::Get_Picking_Terrain_Pos(_float3* pVOutPutPos)
{
	...
	CVIBuffer_FlatTerrain* ptex = dynamic_cast<CVIBuffer_FlatTerrain*>(CGameInstance::GetInstance()->Get_Component(CVIBuffer_FlatTerrain::familyId, iLevelindex, L"Layer_Terrain", L"Terrain"));
	if (nullptr == ptex)
		return E_FAIL;

	CTransform* pTransCom = dynamic_cast<CTransform*>(CGameInstance::GetInstance()->Get_Component(CTransform::familyId, iLevelindex, L"Layer_Terrain", L"Terrain"));
	...
	CVIBuffer_FlatTerrain* pTerrainBufferCom = dynamic_cast<CVIBuffer_FlatTerrain*>(CGameInstance::GetInstance()->Get_Component(CVIBuffer_FlatTerrain::familyId, iLevelindex, L"Layer_Terrain", L"Terrain"));
...
void CMapToolGUI::Move_Brush()
{
	...
	CTexture* pBrushTexture = dynamic_cast<CTexture*>(CGameInstance::GetInstance()->Get_Component(FAMILY_ID_TEXTURE_BRUSH, iLevelindex, L"Layer_Terrain", L"Terrain"));
