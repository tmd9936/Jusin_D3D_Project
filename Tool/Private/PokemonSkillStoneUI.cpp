...
CPokemonSkillStoneUI::CPokemonSkillStoneUI(const CPokemonSkillStoneUI& rhs)
	: CUI(rhs)
{
}

HRESULT CPokemonSkillStoneUI::Initialize_Prototype()
{
...
HRESULT CPokemonSkillStoneUI::Initialize(const _tchar* pLayerTag, _uint iLevelIndex, void* pArg)
{
...
HRESULT CPokemonSkillStoneUI::Initialize(const _tchar* pLayerTag, _uint iLevelIndex, const char* filePath)
{
...
HRESULT CPokemonSkillStoneUI::Init_PokemonData(const _uint& nowMonsterNumber)
{
...
HRESULT CPokemonSkillStoneUI::Get_PokemonData()
{
...
_bool CPokemonSkillStoneUI::Save_By_JsonFile_Impl(Document& doc, Document::AllocatorType& allocator)
{
	std::wstring_convert<std::codecvt_utf8_utf16<wchar_t>, wchar_t> convert;
...
_bool CPokemonSkillStoneUI::Load_By_JsonFile_Impl(Document& doc)
{
	std::wstring_convert<std::codecvt_utf8_utf16<wchar_t>, wchar_t> convert;
	...
	m_PokemonSkillStone_Desc.m_nowMonsterNumber = UIDesc["m_nowMonsterNumber"].GetUint();
...
CPokemonSkillStoneUI* CPokemonSkillStoneUI::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CPokemonSkillStoneUI* pInstance = new CPokemonSkillStoneUI(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created CPokemonSkillStoneUI");
...
CGameObject* CPokemonSkillStoneUI::Clone(const _tchar* pLayerTag, _uint iLevelIndex, void* pArg)
{
	CPokemonSkillStoneUI* pInstance = new CPokemonSkillStoneUI(*this);

	if (FAILED(pInstance->Initialize(pLayerTag, iLevelIndex, pArg)))
	{
		MSG_BOX("Failed to Cloned CPokemonSkillStoneUI");
		Safe_Release(pInstance);
	}
...
CGameObject* CPokemonSkillStoneUI::Clone(const _tchar* pLayerTag, _uint iLevelIndex, const char* filePath)
{
	CPokemonSkillStoneUI* pInstance = new CPokemonSkillStoneUI(*this);
