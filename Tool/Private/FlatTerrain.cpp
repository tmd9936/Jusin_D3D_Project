...
HRESULT CFlatTerrain::Add_Components()
{
	...
	/* For.Com_Mask */
	if (FAILED(pGameInstance->Add_Component(FAMILY_ID_TEXTURE_MASK, this, LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_TerrainMask"),
		(CComponent**)&m_pTextureCom[TYPE_MASK], nullptr)))
		return E_FAIL;

	/* For.Com_Brush */
	if (FAILED(pGameInstance->Add_Component(FAMILY_ID_TEXTURE_BRUSH, this, LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_Brush"),
