...
void main()
{
    u_xlat16_0 = dot(vs_TEXCOORD0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_0 = max(u_xlat16_0, 0.0);
    u_xlat16_2.xyz = vs_TEXCOORD2.xyz + _Color.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = vs_TEXCOORD2.xyz + _Color.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_TEXCOORD1.xyz + _Color.xyz;
...
void main()
{
    SV_Target0.xyz = vs_TEXCOORD2.xyz + _Color.xyz;
    SV_Target0.w = 1.0;
...
{
    SV_Target0.w = 1.0;
    u_xlat16_0.xyz = vs_TEXCOORD2.xyz + _Color.xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vs_TEXCOORD4.xyz;
