...
//
///////////////////////////////////////////
Shader "Custom/Gf/EffectOutline" {
Properties {
_Color ("Main Color", Color) = (1,1,1,1)
_MainTex ("Base (RGB)", 2D) = "white" { }
_OutlineSize ("Outline width", Range(0.002, 0.5)) = 0.1
_OutLineColor ("Out Line Color", Color) = (1,1,1,0.5)
}
SubShader {
 LOD 200
...
void main()
{
    u_xlat0.xyz = in_NORMAL0.xyz * vec3(_OutlineSize) + in_POSITION0.xyz;
