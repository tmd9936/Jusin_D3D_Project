...
public: /* For.Object_Manager */
	...
	HRESULT Add_GameObject(const _tchar* pPrototypeTag, _uint iLevelIndex, const _tchar* pLayerTag, CGameObject* pOut, const _tchar* pObjectNameTag = nullptr, void* pArg = nullptr);
