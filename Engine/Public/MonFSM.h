...
public:
	enum MONSTER_STATE {
		...
		DASH_SLE_END, DASH_SLE_LOOP, DASH_SLE_START, DEAD_LASTBOSS_ESC, DEAD_BOSS, DEAD_LASTBOSS, DEAD_ROTATE,
		...
		SUFFER, TALK, TREMBLING, TURN360_SLE_END, TURN360_SLE_LOOP, TURN360_SLE_START, VERTICAL_JUMP, END_MOTION
	};
